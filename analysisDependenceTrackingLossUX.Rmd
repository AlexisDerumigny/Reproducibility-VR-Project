...
data_all$NrTrackerlossesOp = - data_all$NrTrackerlosses #invert, so better = less tracker losses
...
dataCorMat = data_all[, selectedQuestions] %>%
  rename(
    ...
    `Fewer trackinglosses` = `NrTrackerlossesOp`,
...
```
```{r}
print(data_all$`Self-motion compellingness`)
```
