...
allQuestionsGroups = unique(data_questions$QuestionGroup)
data_all$completionTimeOp = - data_all$completionTime #invert, so better = less time taken
...
# ```{r}
# dataUXTime_pivot = dataUXTime |>
#   mutate(LocomotionTechniqueOrder = paste(LocomotionTechnique, orderCondition, sep = ""))
# 
# my_model = lmer(
#   data = dataUXTime_pivot,
#   completionTimeOp ~ LocomotionTechnique * QuestionGroup + LocomotionTechniqueOrder +
